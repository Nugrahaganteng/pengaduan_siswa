                            ...
                            @else
                                ...
                                @if (Route::has('register'))
                                  ...
                                  <div class="pt-3 sm:pt-5 lg:pt-0">
                                        ...
                                        <a href="{{route('news.index')}}" class="inline-flex text-white bg-primary-600 hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:focus:ring-primary-900 my-4"> newsssss</a>
                                    </div>
                               <br>
